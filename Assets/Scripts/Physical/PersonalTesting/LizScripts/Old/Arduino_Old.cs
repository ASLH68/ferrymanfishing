...
public class Arduino_Old : MonoBehaviour
{
    public static Arduino_Old Instance;
    ...
    private ArduinoThread_Old _arduinoThread;
    ...
    private void Awake()
    {
        ...
        _arduinoThread = new ArduinoThread_Old(port, _baudRate, _readTimeout, _writeTimeout);
    }
    ...
    public ArduinoThread_Old GetThread()
    {
